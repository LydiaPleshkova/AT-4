...
public class appCardDeliveryTest {
    ...
    public void shouldBeSuccessfulCompleted() {
        ...
        String futureDate = generateDate(4, "dd.MM.yyyy");
        $("[data-test-id='date'] input").sendKeys(Keys.chord(Keys.SHIFT, Keys.HOME), Keys.DELETE);
        $("[data-test-id='date'] input").sendKeys("12.07.2023");
        ...
        $(".notification__content")
                ...
                .shouldHave(Condition.exactText("Успешно! Встреча успешно зарегистрирована на " + futureDate));
    }
}